...
import type { ChatMessageContent as _ChatMessageContent, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRegistration as _UserRegistration, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getChat(): Promise<Array<ChatMessageContent>> {
        if (this.processError) {
            try {
                const result = await this.actor.getChat();
    ...
    async postAnnouncement(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async registerUser(arg0: UserRegistration): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerUser(await to_candid_UserRegistration_n19(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendMessage(arg0: ChatMessageContent): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.sendMessage(await to_candid_ChatMessageContent_n23(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_ChatMessageContent_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ChatMessageContent): Promise<ChatMessageContent> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        aadharPhoto: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.aadharPhoto)
    };
}
...
async function from_candid_vec_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ChatMessageContent>): Promise<Array<ChatMessageContent>> {
    return await Promise.all(value.map(async (x)=>await from_candid_ChatMessageContent_n17(_uploadFile, _downloadFile, x)));
}
async function to_candid_ChatMessageContent_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ChatMessageContent): Promise<_ChatMessageContent> {
    return await to_candid_variant_n24(_uploadFile, _downloadFile, value);
}
...
async function to_candid_UserRegistration_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UserRegistration): Promise<_UserRegistration> {
    return await to_candid_record_n20(_uploadFile, _downloadFile, value);
}
...
async function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        fatherName: value.fatherName,
        village: value.village,
        aadharPhoto: await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.aadharPhoto)
    };
}
...
async function to_candid_variant_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    __kind__: "video";
    video: ExternalBlob;
} | {
    __kind__: "text";
    ...
    return value.__kind__ === "video" ? {
        video: await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.video)
    } : value.__kind__ === "text" ? {
        text: value.text
    } : value.__kind__ === "photo" ? {
        photo: await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.photo)
    } : value;
}
